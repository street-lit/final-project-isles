...
class ObservationsControllerTest < ActionController::TestCase
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post :create, observation: { album_id: @observation.album_id, body: @observation.body, photo_id: @observation.photo_id, user_id: @observation.user_id }
    end
  ...
  test "should update observation" do
    patch :update, id: @observation, observation: { album_id: @observation.album_id, body: @observation.body, photo_id: @observation.photo_id, user_id: @observation.user_id }
    assert_redirected_to observation_path(assigns(:observation))
  end
