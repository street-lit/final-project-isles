class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :username, :age, :city, :state, :twitter, :github, :linkedin, :phone_number, :birthday, :soundcloud, :facebook, :password, :image)
    end
end
